...
//           month: employeeData.month || new Date().toISOString().slice(0, 7),
//           paidDays: employeeData.paidDays || 0,
//           lopDays: employeeData.lopDays || 0,
//           remainingLeave: employeeData.remainingLeave || 0,
//           leavesTaken: employeeData.leavesTaken || 0,
...
//         setMessage('Error fetching employee data: ' + (error.response?.data?.error || error.message))
//       } finally {
//         setFetching(false)
//       }
//     }
...
//     setFormData(prev => ({
//       ...prev,
//       [name]: name === 'paidDays' || name === 'lopDays' || name === 'remainingLeave' || name === 'leavesTaken' 
//         ? parseInt(value) || 0 
//         : value
//     }))
//   }
...
//         setTimeout(() => onEmployeeUpdated(), 1000) // Wait a second before refreshing
//       }
//     } catch (error) {
//       console.error('Error updating employee:', error)
//       setMessage('Error updating employee: ' + (error.response?.data?.error || error.message))
//     } finally {
//       setLoading(false)
//     }
//   }
